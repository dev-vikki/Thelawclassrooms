    ...
    <div className="px-6 py-10 leading-relaxed font-sans text-gray-200 max-w-5xl mx-auto">
      <div className="max-w-4xl mx-auto bg-[#1e1e1e] rounded-md p-6">
        ...
        <section className="mb-8">
          <p className="mb-4">
            The present Terms of Use document is published in accordance with
          ...
          <p>
            ...
            ), including all subdomains, hereinafter the "Website". The Website
            is owned and operated by The Law classrooms, a legal education and
        ...
        <section className="mb-8">
          ...
          <p>
            If you do not understand or agree with any part of these Terms of
            Use, you should immediately discontinue using or accessing the
            Website.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside mb-2">
            ...
            <li>
              Have attained the legal age necessary under applicable Indian
              laws.
            </li>
            <li>
