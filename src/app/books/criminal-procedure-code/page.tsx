            ...
            <div className="flex justify-between items-start mb-0">
              <div>
                ...
                <p className="text-gray-400 mt-2 max-w-2xl text-sm">
                  ...
                  Master criminal procedure with our comprehensive topic wise
                  MCQs. Experience exam like pressure with timed tests. Your
                  gateway to mastering CRPC with accuracy and confidence.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                {/* <img
