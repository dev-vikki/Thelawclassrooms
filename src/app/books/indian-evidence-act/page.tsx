...
const topics = [
  { title: 'Preliminary', section: 'Sections 1–4', highlight: false },
  { title: 'Li: of the Relevancy of Fact', section: 'Sections 5-55', highlight: false },
  { title: 'Chapter III: Facts which need not be proved', section: 'Sections 56-58', highlight: false },
  { title: 'Chapter IV: of Oral Evidence', section: 'Sections 59-60A', highlight: false },
  { title: 'Chapter V: of Documentary Evidence', section: 'Sections 61-90A', highlight: false },
  { title: 'Chapter VI: of the exclusion of Oral by Documentary Evidence', section: 'Sections 91-100', highlight: false },
  { title: 'Chapter VII: of the Burden of Proof', section: 'Sections 101-114A', highlight: false },
  { title: 'Chapter VIII: Estoppel', section: 'Sections 115-117', highlight: false },
  { title: 'Chapter IX: of Witnesses', section: 'Sections 118-134', highlight: false },
  { title: 'Chapter X: of the Examination of Witnesses', section: 'Sections 135-166', highlight: false },
  { title: 'Chapter XI: of Improper Admission and Rejection of Evidence', section: 'Section 167', highlight: false }

];

export default function IEApage() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 max-w-7xl mx-auto px-4 py-8 gap-6">
        ...
        <section className="md:col-span-3 pr-6 space-y-6">
          <div className="flex justify-between items-start mb-0">
            <div>
              <h1 className="text-2xl font-bold uppercase">Indian Evidence Act,</h1>
              <p className="text-gray-400 mt-2 max-w-2xl text-sm">
                Master Indian evidence act with our comprehensive topic wise MCQs.
                Experience exam like pressure with timed tests.
                Your gateway to mastering IEA with accuracy and confidence.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
            {/* <img
