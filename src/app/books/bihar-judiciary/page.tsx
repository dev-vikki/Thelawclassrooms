...
const topics = [
   ...
   { title: 'BPSC Judiciary Civil Judge Previous Year Question, GK, 2016', section: '100 questions', highlight: false },
  { title: 'BPSC Judiciary Civil Judge Previous Year Question, LAW, 2016', section: '150 questions', highlight: false },
  { title: 'BPSC Judiciary Civil Judge Previous Year Question, GK, 2018', section: '100 questions', highlight: false },
  { title: 'BPSC Judiciary Civil Judge Previous Year Question, LAW, 2018', section: '150 questions', highlight: false },
  { title: 'BPSC Judiciary Civil Judge Previous Year Question, GK, 2020', section: '100 questions', highlight: false },
  { title: 'BPSC Judiciary Civil Judge Previous Year Question, LAW, 2020', section: '150 questions', highlight: false },
  { title: 'BPSC Judiciary Civil Judge Previous Year Question, GK, 2022', section: '100 questions', highlight: false },
  { title: 'BPSC Judiciary Civil Judge Previous Year Question, LAW, 2022', section: '150 questions', highlight: false }
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 max-w-7xl mx-auto px-4 py-8 gap-6">
        ...
        <section className="md:col-span-3 pr-6 space-y-6">
          <div className="flex justify-between items-start mb-0">
            <div>
              <h1 className="text-2xl font-bold uppercase">bihar judiciary Civil Judge Previous Year Question</h1>
