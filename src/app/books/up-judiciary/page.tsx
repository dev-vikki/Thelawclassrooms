...
const topics = [
 ...
 { title: 'UPPSC Judiciary Civil Judge Previous Year Question, GK, 2015', section: '150 questions', highlight: false },
  { title: 'UPPSC Judiciary Civil Judge Previous Year Question, LAW, 2015', section: '150 questions', highlight: false },
  { title: 'UPPSC Judiciary Civil Judge Previous Year Question, GK, 2016', section: '150 questions', highlight: false },
  { title: 'UPPSC Judiciary Civil Judge Previous Year Question, LAW, 2016', section: '150 questions', highlight: false },
  { title: 'UPPSC Judiciary Civil Judge Previous Year Question, GK, 2018', section: '150 questions', highlight: false },
  { title: 'UPPSC Judiciary Civil Judge Previous Year Question, LAW, 2018', section: '150 questions', highlight: false },
  { title: 'UPPSC Judiciary Civil Judge Previous Year Question, GK, 2023', section: '150 questions', highlight: false },
  { title: 'UPPSC Judiciary Civil Judge Previous Year Question, LAW, 2023', section: '150 questions', highlight: false },


];

export default function uttarpradeshjudiciarypage() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 max-w-7xl mx-auto px-4 py-8 gap-6">
        ...
        <section className="md:col-span-3 pr-6 space-y-6">
          <div className="flex justify-between items-start mb-0">
            <div>
              <h1 className="text-2xl font-bold uppercase">uttar pradesh judiciary Civil Judge Previous Year Question</h1>
