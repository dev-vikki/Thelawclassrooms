...
const topics = [
  ...
  { title: 'CGPSC Judiciary Civil Judge Previous Year Question, 2014', section: '100 questions', highlight: false },
  { title: 'CGPSC Judiciary Civil Judge Previous Year Question, 2015', section: '100 questions', highlight: false },
  { title: 'CGPSC Judiciary Civil Judge Previous Year Question, 2016', section: '100 questions', highlight: false },
  { title: 'CGPSC Judiciary Civil Judge Previous Year Question, 2017', section: '100 questions', highlight: false },
  { title: 'CGPSC Judiciary Civil Judge Previous Year Question, 2018', section: '100 questions', highlight: false },
  { title: 'CGPSC Judiciary Civil Judge Previous Year Question, 2019', section: '100 questions', highlight: false },
  { title: 'CGPSC Judiciary Civil Judge Previous Year Question, 2020', section: '100 questions', highlight: false },
  { title: 'CGPSC Judiciary Civil Judge Previous Year Question, 2023', section: '100 questions', highlight: false }


];

export default function chattisgarhjudiciarypage() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 max-w-7xl mx-auto px-4 py-8 gap-6">
        ...
        <section className="md:col-span-3 pr-6 space-y-6">
          <div className="flex justify-between items-start mb-0">
            <div>
              <h1 className="text-2xl font-bold uppercase">chattisgarh judiciary Civil Judge Previous Year Question</h1>
