...
const topics = [
  ...
  { title: 'Of transfers of property by act of parties', section: 'Sections 5-53A', highlight: false },
  { title: 'Of Sales of Immoveable Property', section: 'Sections 54-57', highlight: false },
  { title: 'Of Mortgages of Immoveable Property and Charges', section: 'Sections 58-104', highlight: false },
  { title: 'Leases of Immoveable Property', section: 'Sections 105-117', highlight: false },
  { title: 'Processes to Compel Appearance', section: 'Sections 106-124', highlight: false },
  { title: 'Of Exchanges', section: 'Sections 118-121', highlight: false },
  { title: 'Of Gifts', section: 'Sections 122-129', highlight: false },
  { title: 'Of Transfers of Actionable Claims', section: 'Sections 130-137', highlight: false }
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 max-w-7xl mx-auto px-4 py-8 gap-6">
        ...
        <section className="md:col-span-3 pr-6 space-y-6">
          <div className="flex justify-between items-start mb-0">
            <div>
              <h1 className="text-2xl font-bold uppercase">Transfer of property Act,</h1>
              <p className="text-gray-400 mt-2 max-w-2xl text-sm">
                Master Transfer of property act with our comprehensive topic wise MCQs.
                Experience exam like pressure with timed tests.
                Your gateway to mastering TPA with accuracy and confidence.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
            {/* <img
