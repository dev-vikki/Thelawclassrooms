...
const topics = [
  ...
  { title: 'Communication, acceptance & Revocation of Proposal', section: 'Sections 3-9', highlight: false },
  { title: 'Chapter II: Of Contract, Voidable Contract and Void Agreements', section: 'Sections 10-30', highlight: false },
  { title: 'Chapter III: Of Contingent Contract', section: 'Sections 31-36', highlight: false },
  { title: 'Chapter IV: of the performance of Contracts', section: 'Sections 37-67', highlight: false },
  { title: 'Chapter V: Of certain relations Resembling Those Created by contract', section: 'Sections 68-72', highlight: false },
  { title: 'Chapter VI: Of the Consequences of Breach of Contract', section: 'Section 73-75', highlight: false }
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 max-w-7xl mx-auto px-4 py-8 gap-6">
        ...
        <section className="md:col-span-3 pr-6 space-y-6">
          <div className="flex justify-between items-start mb-0">
            <div>
              <h1 className="text-2xl font-bold uppercase">Indian contract Act,</h1>
