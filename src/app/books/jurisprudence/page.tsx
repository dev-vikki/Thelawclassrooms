...
const topics = [
  ...
  { title: 'Schools of Jurisprudence', section: '', highlight: false },
  { title: 'Sources of Law', section: '', highlight: false },
  { title: 'Legal Rights and Duties', section: '', highlight: false },
  { title: 'Ownership & Possession', section: '', highlight: false },
  { title: 'Legal Personality & Administration of Justice', section: '', highlight: false }
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 max-w-7xl mx-auto px-4 py-8 gap-6">
        ...
        <section className="md:col-span-3 pr-6 space-y-6">
          <div className="flex justify-between items-start mb-0">
            <div>
              <h1 className="text-2xl font-bold uppercase">jurisprudence,</h1>
              <p className="text-gray-400 mt-2 max-w-2xl text-sm">
                Master Jurisprudence with our comprehensive topic wise MCQs.
                Experience exam like pressure with timed tests.
                Your gateway to mastering jurisprudence with accuracy and confidence.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
            {/* <img
