...
const topics = [
   ...
   { title: 'HPPSC Judiciary Civil Judge Previous Year Question, 2007', section: '150 questions', highlight: false },
  { title: 'HPPSC Judiciary Civil Judge Previous Year Question, 2009', section: '150 questions', highlight: false },
  { title: 'HPPSC Judiciary Civil Judge Previous Year Question, 2010', section: '150 questions', highlight: false },
  { title: 'HPPSC Judiciary Civil Judge Previous Year Question, 2012', section: '150 questions', highlight: false },
  { title: 'HPPSC Judiciary Civil Judge Previous Year Question, 2013', section: '150 questions', highlight: false },
  { title: 'HPPSC Judiciary Civil Judge Previous Year Question, 2016', section: '150 questions', highlight: false },
  { title: 'HPPSC Judiciary Civil Judge Previous Year Question, 2018', section: '150 questions', highlight: false },
  { title: 'HPPSC Judiciary Civil Judge Previous Year Question, 2019', section: '150 questions', highlight: false }


];

export default function Himanchaljudiciarypage() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 max-w-7xl mx-auto px-4 py-8 gap-6">
        ...
        <section className="md:col-span-3 pr-6 space-y-6">
          <div className="flex justify-between items-start mb-0">
            <div>
              <h1 className="text-2xl font-bold uppercase">himanchal judiciary Civil Judge Previous Year Question</h1>
